...
.PHONY: check vcheck check-examples indent stamp clean
...
check: cstrm.o
	...
	do \
	  ...
	  ( $(CC)    $(CPPFLAGS) $(OTHER_INCLUDE) $(CFLAGS) $(OTHER_SOURCE) \
		-o t/a.out $$i.c cstrm.o cbuf.c $(LDFLAGS) ) \
	  && ( t/a.out ); \
	done 
...
echeck: cstrm.o
	...
	do \
	  ...
	  echo "Running test $$i ..."; \
	  ( $(CC)    $(CPPFLAGS) $(OTHER_INCLUDE) $(CFLAGS) $(OTHER_SOURCE) \
		-o t/a.out $$i.c cstrm.o cbuf.c $(LDFLAGS_EFENCE) ) \
	  && ( LD_PRELOAD=libefence.so ./t/a.out ); \
	done 

check-examples: cstrm.o
	echo "--------------------"; \
	echo "Checking ex/ex_stdin_1.c  ..."; \
	( $(CC) -g $(CPPFLAGS) $(OTHER_INCLUDE) $(CFLAGS) $(OTHER_SOURCE) \
		-o ex/a.out ex/ex_stdin_1.c cstrm.o cbuf.c $(LDFLAGS) ) \
		&& ( valgrind $(VALGRIND_FLAGS) ex/a.out < README.md ); \
	echo "Checking ex/ex_stdin_2.c  ..."; \
	( $(CC) -g $(CPPFLAGS) $(OTHER_INCLUDE) $(CFLAGS) $(OTHER_SOURCE) \
		-o ex/a.out ex/ex_stdin_2.c cstrm.o cbuf.c $(LDFLAGS) ) \
		&& ( valgrind $(VALGRIND_FLAGS) ex/a.out < README.md ); \
	echo "Checking ex/ex_file_1.c  ..."; \
	( $(CC) -g $(CPPFLAGS) $(OTHER_INCLUDE) $(CFLAGS) $(OTHER_SOURCE) \
		-o ex/a.out ex/ex_file_1.c cstrm.o cbuf.c $(LDFLAGS) ) \
		&& ( valgrind $(VALGRIND_FLAGS) ex/a.out README.md ); \
	echo "Checking ex/ex_file_2.c  ..."; \
	( $(CC) -g $(CPPFLAGS) $(OTHER_INCLUDE) $(CFLAGS) $(OTHER_SOURCE) \
		-o ex/a.out ex/ex_file_2.c cstrm.o cbuf.c $(LDFLAGS) ) \
		&& ( valgrind $(VALGRIND_FLAGS) ex/a.out README.md ); \
	echo "Checking ex/ex_string_1.c  ..."; \
	( $(CC) -g $(CPPFLAGS) $(OTHER_INCLUDE) $(CFLAGS) $(OTHER_SOURCE) \
		-o ex/a.out ex/ex_string_1.c cstrm.o cbuf.c $(LDFLAGS) ) \
		&& ( valgrind $(VALGRIND_FLAGS) ex/a.out README.md ); \
	echo "Checking ex/ex_string_2.c  ..."; \
	( $(CC) -g $(CPPFLAGS) $(OTHER_INCLUDE) $(CFLAGS) $(OTHER_SOURCE) \
		-o ex/a.out ex/ex_string_2.c cstrm.o cbuf.c $(LDFLAGS) ) \
		&& ( valgrind $(VALGRIND_FLAGS) ex/a.out README.md ); \
